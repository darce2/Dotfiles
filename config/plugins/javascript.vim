...
Plug 'carlitux/deoplete-ternjs', { 'do': 'npm install -g tern', 'for': ['javascript', 'javascript.jsx'] }    " deopplet compatibility i think
...
" Plug 'mtscout6/syntastic-local-eslint.vim'                                      " Use local eslint file
